...
Now,
\begin{align}
    x\brak{0}+pd &= a \label{eq:"praf1"} \\
    x\brak{0}+qd &= b \label{eq:"praf2"} \\
    x\brak{0}+rd &= c \label{eq:"praf3"} \\
    p-q &= \frac{a-b}{d} \label{eq:"praf4"} \\
    q-r &= \frac{b-c}{d} \label{eq:"praf5"} \\
    r-p &= \frac{c-a}{d} \label{eq:"praf6"}
\end{align}
Now, from \eqref{eq:"praf4"}, \eqref{eq:"praf5"} and \eqref{eq:"praf6"},
\begin{align}
    \brak{q-r}a + \brak{r-p}b + \brak{p-q}c &= \frac{b-c}{d}.a +  \frac{c-a}{d}.b + \frac{a-b}{d}.c \label{eq:"praf7"}\\
    &= 0
\end{align}
Hence proved
\end{document}
