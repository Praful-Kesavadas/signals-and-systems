...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/filter/codes/plot1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/filter/codes/sk_gen.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/filter/codes/pole_zero_plt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
Plot fot Figure 3
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/filter/codes/plot2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Ashley-Ann-Benoy/EE1205/blob/main/filter/codes/plot3.py
\end{lstlisting}
\subsection{The Digital Filter}
